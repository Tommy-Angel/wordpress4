	...
	<div class="youzify-content">
		...
		<main class="youzify-page-main-content">
			...
			<div class="youzify-mobile-nav">
				<div class="youzify-mobile-nav-item youzify-show-activity-menu"><div class="youzify-mobile-nav-container"><i class="fas fa-bars"></i><a><?php _e( 'Menu', 'teamhost' ); ?></a></div></div>
				<div class="youzify-mobile-nav-item youzify-show-activity-search"><div class="youzify-mobile-nav-container"><i class="fas fa-search"></i><a><?php _e( 'Search', 'teamhost' ); ?></a></div></div>
				<div class="youzify-mobile-nav-item youzify-show-activity-filter"><div class="youzify-mobile-nav-container"><i class="fas fa-sliders-h"></i><a><?php _e( 'Filter', 'teamhost' ); ?></a></div></div>
			</div>

			<div id="youzify-wall-nav">
				<div class="item-list-tabs activity-type-tabs" aria-label="<?php esc_attr_e( 'Sitewide activities navigation', 'teamhost' ); ?>" role="navigation">
					<ul>
						<?php
						...
						<li id="activity-all" class="selected"><a href="<?php bp_activity_directory_permalink(); ?>"><?php printf( __( 'All Members %s', 'teamhost' ), '<span>' . bp_get_total_member_count() . '</span>' ); ?></a></li>
						...
						<?php if ( is_user_logged_in() ) : ?>
							...
							<?php if ( bp_is_active( 'friends' ) ) : ?>
								...
								<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
									...
									<li id="activity-friends"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/'; ?>"><?php printf( __( 'My Friends %s', 'teamhost' ), '<span>' . bp_get_total_friend_count( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
							...
							<?php if ( bp_is_active( 'groups' ) ) : ?>
								...
								<?php if ( bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
									...
									<li id="activity-groups"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_groups_slug() . '/'; ?>"><?php printf( __( 'My Groups %s', 'teamhost' ), '<span>' . bp_get_total_group_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
							...
							<?php if ( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) : ?>
								...
								<li id="activity-favorites"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/favorites/'; ?>"><?php printf( __( 'My Favorites %s', 'teamhost' ), '<span>' . bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
							...
							<?php if ( bp_activity_do_mentions() ) : ?>
								...
								<li id="activity-mentions"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/mentions/'; ?>"><?php _e( 'Mentions', 'teamhost' ); ?><?php if ( bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ) : ?> <strong><span><?php printf( _nx( '%s new', '%s new', bp_get_total_mention_count_for_user( bp_loggedin_user_id() ), 'Number of new activity mentions', 'teamhost' ), bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ); ?></span></strong><?php endif; ?></a></li>
				...
				<div class="item-list-tabs activity-type-tabs-subnav no-ajax" id="subnav" aria-label="<?php esc_attr_e( 'Activity secondary navigation', 'teamhost' ); ?>" role="navigation">
					<ul>
						<?php
						...
						<li id="activity-filter-select" class="last">
							...
							<label for="activity-filter-by"><?php _e( 'Filter Activities By :', 'teamhost' ); ?></label>
							<select id="activity-filter-by" class="youzify-bar-select">
								<option value="-1"><?php _e( '&mdash; Everything &mdash;', 'teamhost' ); ?></option>
						...
						<li class="youzify-activity-show-search">
							...
							<div class="youzify-dropdown-area">
								<div class="youzify-activity-search">
									...
									<input type="text" name="s" placeholder="<?php _e( 'Search Activities ...', 'teamhost' ); ?>">
