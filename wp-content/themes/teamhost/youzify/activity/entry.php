...
<li class="<?php bp_activity_css_class(); ?>" data-effect="fadeInDown" id="activity-<?php bp_activity_id(); ?>">
	...
	<div class="activity-content">
		...
		<div class="activity-header">
			...
			<div class="activity-avatar"><a href="<?php bp_activity_user_link(); ?>"><?php bp_activity_avatar(array( 'type' => 'full' )); ?></a></div>
		...
		<div class="activity-meta" data-activity-id="<?php echo bp_get_activity_id(); ?>"><?php
			...
			if ( bp_get_activity_type() == 'activity_comment' && is_user_logged_in() ) : ?><a href="<?php bp_activity_thread_permalink(); ?>" class="button view bp-secondary-action"><?php _e( 'View Conversation', 'teamhost' ); ?></a><?php
			...
			if ( is_user_logged_in() ) :
				...
				if ( bp_activity_can_comment() ) : ?><a href="<?php bp_activity_comment_link(); ?>" class="button acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>"><?php _e( 'Comment', 'teamhost' ); ?></a><?php
					...
					<div class="ac-reply-content">
						<div class="ac-textarea<?php if ( $emoji_active ) echo ' youzify-comments-emojis';?>">
							<label for="ac-input-<?php bp_activity_id(); ?>" class="bp-screen-reader-text"><?php
								_e( 'Comment', 'teamhost' );
							?></label>
							<textarea id="ac-input-<?php bp_activity_id(); ?>" class="ac-input bp-suggestions" name="ac_input_<?php bp_activity_id(); ?>" placeholder="<?php _e( 'Write a Comment ...', 'teamhost' ); ?>"></textarea>
							<?php if ( $emoji_active ) : ?>
								<div class="youzify-load-emojis"><i class="far fa-smile"></i></div>
							<?php endif; ?>
						</div>
						<input type="submit" name="ac_form_submit" value="<?php esc_attr_e( 'Post', 'teamhost' ); ?>" style="display: none;">
