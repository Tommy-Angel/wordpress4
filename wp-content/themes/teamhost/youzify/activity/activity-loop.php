...
<?php if ( bp_has_activities( $request ) ) : ?>
	...
	<?php if ( bp_activity_has_more_items() ) : ?>
		...
		<li class="load-more">
			<a href="<?php bp_activity_load_more_link() ?>"><i class="fas fa-level-down-alt"></i><?php _e( 'Load More Posts', 'teamhost' ); ?></a>
		</li>
...
<?php else : ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'Sorry, there was no activity found. Please try a different filter.', 'teamhost' ); ?></p>
	</div>
