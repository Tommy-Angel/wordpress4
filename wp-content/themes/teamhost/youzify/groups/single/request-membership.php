...
<?php if ( ! bp_group_has_requested_membership() ) : ?>
	...
	<p class="description"><?php printf( __( "You are requesting to become a member of the group '%s'.", 'teamhost' ), bp_get_group_name( false ) ); ?></p>

	<form action="<?php bp_group_form_action( 'request-membership' ); ?>" method="post" name="request-membership-form" id="request-membership-form" class="standard-form">

		<div class="youzify-group-field-item">
			<label for="group-request-membership-comments"><?php _e( 'Comments (optional)', 'teamhost' ); ?></label>
		...
		<div class="youzify-group-submit-form">
			<input type="submit" name="group-request-send" id="group-request-send" value="<?php esc_attr_e( 'Send Request', 'teamhost' ); ?>" />
		</div>
