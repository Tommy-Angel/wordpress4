...
<div class="youzify-group-settings-tab">
	...
	<div class="youzify-group-field-item">
		<label for="group-name"><?php _e( 'Group Name (required)', 'teamhost' ); ?></label>
		<input type="text" name="group-name" id="group-name" value="<?php bp_group_name(); ?>" aria-required="true" />
	</div>

	<div class="youzify-group-field-item">
		<label for="group-desc"><?php _e( 'Group Description (required)', 'teamhost' ); ?></label>
	...
	<div class="youzify-group-field-item">
		<label for="group-notify-members">
			<input type="checkbox" name="group-notify-members" id="group-notify-members" value="1" /> <?php _e( 'Notify group members of these changes via email', 'teamhost' ); ?>
		</label>
	</div>
