...
<div class="youzify-group-settings-tab youzify-delete-group-tab">
	...
	<div id="message" class="error">
		<p><?php _e( 'WARNING: Deleting this group will completely remove ALL content associated with it. There is no way back, please be careful with this option.', 'teamhost' ); ?></p>
	</div>


	<label for="delete-group-understand"><input type="checkbox" name="delete-group-understand" id="delete-group-understand" value="1" onclick="if(this.checked) { document.getElementById('delete-group-button').disabled = ''; } else { document.getElementById('delete-group-button').disabled = 'disabled'; }" /> <?php _e( 'I understand the consequences of deleting this group.', 'teamhost' ); ?></label>
	...
	<div class="submit">
		<input type="submit" disabled="disabled" value="<?php esc_attr_e( 'Delete Group', 'teamhost' ); ?>" id="delete-group-button" name="delete-group-button" />
	</div>
