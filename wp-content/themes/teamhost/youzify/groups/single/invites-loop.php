...
<div class="left-menu">
	...
	<div id="invite-list">
		<div class="list-title"><i class="fas fa-paper-plane"></i><?php _e( 'Invite Your friends', 'teamhost' ); ?></div>
		<ul>
...
<div class="main-column">
	...
	<?php if ( bp_group_has_invites( bp_ajax_querystring( 'invite' ) ) ) : ?>
		...
		<h3 class="section-header"><?php _e( 'Sent Invites', 'teamhost' ); ?></h3>
		...
		<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
			...
			<li id="<?php bp_group_invite_item_id(); ?>">
				...
				<div class="item-data">
					...
					<div class="action">
						<a class="button remove" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php _e( 'Remove Invite', 'teamhost' ); ?></a>
	...
	<?php else : ?>
		...
		<div id="message" class="info">
			<p><?php _e( 'Select friends to invite.', 'teamhost' ); ?></p>
		</div>
