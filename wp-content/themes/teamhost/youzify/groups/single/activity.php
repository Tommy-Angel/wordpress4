...
?>
<div class="item-list-tabs no-ajax" id="subnav" aria-label="<?php esc_attr_e( 'Group secondary navigation', 'teamhost' ); ?>" role="navigation">
	<ul>
		<li class="feed"><a href="<?php bp_group_activity_feed_link(); ?>" class="bp-tooltip" data-bp-tooltip="<?php esc_attr_e( 'RSS Feed', 'teamhost' ); ?>" aria-label="<?php esc_attr_e( 'RSS Feed', 'teamhost' ); ?>"><?php _e( 'RSS', 'teamhost' ); ?></a></li>
		...
		<li id="activity-filter-select" class="last">
			<label for="activity-filter-by"><?php _e( 'Show:', 'teamhost' ); ?></label>
