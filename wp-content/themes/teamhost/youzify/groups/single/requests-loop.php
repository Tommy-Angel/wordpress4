		...
		<li class="item-list">
			<div class="item-data">
				...
				<div class="action">
					...
					<?php bp_button( array( 'id' => 'group_membership_accept', 'component' => 'groups', 'wrapper_class' => 'accept', 'link_href' => bp_get_group_request_accept_link(), 'link_text' => __( 'Accept', 'teamhost' ) ) ); ?>

					<?php bp_button( array( 'id' => 'group_membership_reject', 'component' => 'groups', 'wrapper_class' => 'reject', 'link_href' => bp_get_group_request_reject_link(), 'link_text' => __( 'Reject', 'teamhost' ) ) ); ?>
			...
			<?php if ( ! empty( $requests_template->request->comments ) ): ?>
				<div class="request-comment">
					<span class="request-title"><?php _e( 'Request Comment', 'teamhost' ); ?></span>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'There are no pending membership requests.', 'teamhost' ); ?></p>
	</div>
