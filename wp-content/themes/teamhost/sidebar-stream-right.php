...
if($sidebar_position == 'left'){
    ...
    $page_sidebar_position = 'sidebar_right';
}
...
<?php if( is_active_sidebar( 'sidebar-stream-right' )) { ?>
    <div class="uk-width-1-4@l uk-width-2-5@m sidebar_right <?php echo esc_attr($page_sidebar_sticky); ?>" >
        <aside class="l-sidebar">
            <?php dynamic_sidebar( 'sidebar-stream-right' ); ?>
        </aside>
    </div>
<?php } ?>
