...
<li>
	...
	<div class="product_thumbnail"><?php echo teamhost_return_text($product->get_image());?></div>
	<div class="product_summary">
        ...
        <?php endif; ?>
		<div class="product-price"><?php echo teamhost_return_text($product->get_price_html()); ?></div>
