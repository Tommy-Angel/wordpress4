...
if(teamhost_get_theme_mod('lan_switch_nav') == 'true'){?>
    <?php

    if(!function_exists('teamhost_language_selector')) {
        function teamhost_language_selector() {
    ...
    teamhost_language_selector();
    ?>

<?php } elseif(teamhost_get_theme_mod('lan_shortcode_text')) {
    echo do_shortcode(teamhost_get_theme_mod('lan_shortcode_text'));
}?>
