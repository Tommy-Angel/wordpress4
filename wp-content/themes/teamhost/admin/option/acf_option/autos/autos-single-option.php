...
if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array(
        ...
        'title' => esc_attr__('Gallery','teamhost'),
        'fields' => array(
            array(
                'key' => 'field_5d0e22f0435c2',
                'label' => esc_attr__('Gallery','teamhost'),
                'name' => 'gallery_autos',
                'type' => 'gallery',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                ...
                'label' => esc_attr__('Gallery "Promo Images"','teamhost'),
    ...
    acf_add_local_field_group(array(
        ...
        'title' => esc_attr__('Sub Title Content','teamhost'),
        'fields' => array(
            array(
    ...
    acf_add_local_field_group(array(
        ...
        'title' => esc_attr__('Car List Setting','teamhost'),
        'fields' => array(
            array(
                'key' => 'field_rJpIYNoRrJEam',
                'label' => esc_attr__('Car List Description','teamhost'),
...
if (class_exists('Pixad_Booking_AUTO')){
    acf_add_local_field_group(array(
        ...
        'title' => esc_attr__('Booking Car','teamhost'),
        'fields' => array(
            array(
                'key' => 'field_5de169e31b2d5',
                'label' => esc_attr__('Booking Car','teamhost'),
                'name' => 'booking_car',
                'type' => 'select',
                'instructions' => '',
                'required' => 0,
    ...
    acf_add_local_field_group(array(
        ...
        'title' => esc_attr__('Auto Label','teamhost'),
        'fields' => array(
            array(
                'key' => 'field_5de428b96858f',
                'label' => esc_attr__('Label Auto','teamhost'),
            ...
            array(
                ...
                'label' => esc_attr__('Label Background','teamhost'),
