...
$blog_archive_style = teamhost_get_theme_mod('blog_archive_style', true);
...
$sidebar_float = teamhost_get_theme_mod('blog_template_sidebar', true);
...
$post_per_page = teamhost_get_theme_mod('post_per_page', true);
$post_wrapper_css_class = preg_replace( '/\s+/', ' ', implode( ' ', array_filter( array_unique( $post_wrapper_css_classes ) ) ) );
$max_page = new WP_Query($pages = array('post_type' => 'post', 'posts_per_page' => $post_per_page));
...
<div class="uk-grid fl_main fl_main_post <?php echo esc_attr($wrap_class);?>" data-uk-grid>
    ...
    <?php if(isset($blog_archive_style) && $blog_archive_style == 'default'){?>
        <div class="tm_archive_posts tm_archive_posts_default uk-grid 1111 uk-grid-medium uk-child-width-1-1@s <?php echo esc_attr(trim($css_class)); ?> <?php echo esc_attr(trim($post_wrapper_css_class)); ?>" <?php echo implode(' ', $wrapper_attributes); ?>>
    ...
    <?php } elseif(isset($blog_archive_style) && $blog_archive_style == 'grid'){ ?>
        <div class="tm_archive_posts tm_archive_posts_grid uk-grid uk-grid-medium uk-child-width-1-2@l uk-child-width-2-2@m uk-child-width-1-1@s uk-flex-top uk-flex-wrap-top <?php echo esc_attr(trim($css_class)); ?> <?php echo esc_attr(trim($post_wrapper_css_class)); ?>" <?php echo implode(' ', $wrapper_attributes); ?>>
