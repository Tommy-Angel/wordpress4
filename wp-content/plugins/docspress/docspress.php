...
class DocsPress {
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_style( 'docspress', docspress()->plugin_url . 'assets/css/style.min.css', $css_deps, '2.5.1' );
        wp_style_add_data( 'docspress', 'rtl', 'replace' );
        wp_style_add_data( 'docspress', 'suffix', '.min' );

        wp_enqueue_script( 'docspress', docspress()->plugin_url . 'assets/js/script.min.js', $js_deps, '2.5.1', true );
        wp_localize_script(
            'docspress',
            'docspress_vars',
            array(
