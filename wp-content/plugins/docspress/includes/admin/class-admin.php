...
class DocsPress_Admin {
    ...
    public function admin_scripts( $hook ) {
        ...
        wp_enqueue_script( 'docspress-admin', docspress()->plugin_url . 'assets/admin/js/script.min.js', array( 'jquery', 'jquery-ui-sortable', 'wp-util' ), '2.5.1', true );
        wp_localize_script(
            'docspress-admin',
        ...
        wp_enqueue_style( 'docspress-admin', docspress()->plugin_url . 'assets/admin/css/style.min.css', array(), '2.5.1' );
